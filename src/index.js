 ...
 var newSessionHandler = {
  ...
  'Academics': function () {
   // this.handler.state = states.STARTMODE;
    ...
    var academic_welcomeMessage = "I'm sorry to hear that you are having a hard time with academics. Here is a quote to make you feel better";
  ...
  'Relationships': function () {
   // this.handler.state = states.STARTMODE;
    ...
    var relationship_welcomeMessage  = " It's always hard to navigate relationships. But you are not alone. I hope this can make you feel better <break time= \"1s\"/> The first thing is some words that I think will inspire you <break time= \"3s\"/>";
  ...
  'Finance': function () {
   // this.handler.state = states.STARTMODE;
    ...
    var finance_welcomeMessage  = "If I could help you financially, I would. Sadly I can't, but I think I know how to make you feel better! Remember,";
    finance_welcomeMessage+=randomPhrase(financeQuotes)+"<break time= \"1s\"/>I hope these words have given you some peace of mind. ";
  ...
  'Work': function () {
   // this.handler.state = states.STARTMODE;
    ...
    var work_welcomeMessage  = "I'm sorry to hear that you are facing problems at work. I know how to make you feel better! The first thing is some words that I think will inspire you.";
    work_welcomeMessage+=randomPhrase(workQuotes)+ "<break time= \"1s\"/>I hope these words have given you some peace of mind. ";
  ...
  'Unhandled': function () {
   // this.handler.state = states.STARTMODE;
    ...
    var unhandled_welcomeMessage  = "I'm sorry to hear that. I do not have specific advice for your situation. However, I have a few things in mind to make you feel better. The first thing is some words that I think will inspire you<break time= \"1s\"/>";
    unhandled_welcomeMessage+=randomPhrase(otherQuotes)+ "<break time= \"1s\"/>I hope these words have given you some peace of mind."; 
...
var welcomeMessage = "I'm sorry to hear that. <break time= \"1s\"/> Welcome to the Alexa Baymax program. I may be a bot on Amazon's cloud, but I'm here for you <break time= \"1s\"/>";
var reason = "";
